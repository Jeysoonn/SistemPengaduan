...
import tia from "../../assets/tia.jpg";  // Correct logo import
            ...
            <div className="container px-5">
                <div className="flex items-center flex-col md:flex-row">
                    ...
                    <div className="relative z-10 md:w-1/2 text-center md:text-left mb-10 md:mb-0">
                        <h1 className="text-5xl font-montserrat md:text-6xl font-extrabold text-[#2596be] py-5">
                            Sistem Pengaduan Online PCR
                        </h1>
                        <h3 className="text-lg font-montserrat-regular md:text-l text-gray-700 mb-6">
