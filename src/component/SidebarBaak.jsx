...
const Sidebar = () => {
  ...
  const [laporanOpen, setLaporanOpen] = useState(
    location.pathname.startsWith("/baak/daftar-laporan") ||
    location.pathname.startsWith("/baak/riwayat-daftar-laporan")
  );
  ...
  return (
    <div className="w-64 min-h-screen bg-white flex flex-col justify-between shadow-md">
      {/* Logo */}
      <div className="p-6">
              ...
              return (
                <li key={index}>
                  <button
                    ...
                    className={`flex items-center gap-4 px-4 py-3 rounded-lg text-base font-medium w-full text-left transition-all
                      ${isDropdownActive
      ...
      <div className="p-6 border-t border-gray-100">
        <div className="flex items-center gap-3 mb-4">
          <img
            src={`https://ui-avatars.com/api/?name=${user ? user.nama || user.email : "User"}&background=0891B2&color=ffffff&size=40&bold=true`}
            alt="User"
