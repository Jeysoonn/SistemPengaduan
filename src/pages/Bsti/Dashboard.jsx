...
export default function BSTIDashboard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const khususBAAK = data.filter(
        item => item.tujuan_laporan?.trim().toLowerCase() === "bsti"
      );
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-cyan-800 text-3xl font-bold mb-4">Dashboard BSTI</h1>
      <Breadcrumb />
