...
export default function SecurityDashboard() {
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-black text-2xl font-bold mb-4">Dashboard Security</h1>
      <Breadcrumb items={["Home", "Dashboard", "Security"]} />
      ...
      <div className="mt-8 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-md p-6 text-white">
        <h2 className="text-xl font-bold mb-2">Selamat Datang di Dashboard Security</h2>
        <p className="text-blue-100">
          Anda dapat mengelola dan menindaklanjuti laporan pengaduan yang berkaitan dengan keamanan kampus.
