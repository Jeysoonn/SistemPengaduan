...
export default function Artikel() {
  ...
  return (
    <div className="relative bg-gray-50 text-gray-800 overflow-hidden pb-16">
      ...
      <div aria-hidden="true" className="absolute top-0 left-0 w-full h-40 pointer-events-none overflow-visible -z-10">
        <svg className="w-full h-full" preserveAspectRatio="none" viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg">
          <path fill="#a8d0ff" fillOpacity="0.25" d="M0,64L60,69.3C120,75,240,85,360,90.7C480,96,600,96,720,101.3C840,107,960,117,1080,117.3C1200,117,1320,107,1380,101.3L1440,96L1440,0L0,0Z"></path>
      ...
      <section className="py-16 px-4 md:px-8 max-w-screen-xl mx-auto relative">
        <div className={`flex flex-col space-y-6 transition-all duration-700 ease-out transform ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <div className="flex items-center space-x-6">
            ...
            <div className={`flex-1 bg-white rounded-2xl shadow-lg overflow-hidden transition-opacity duration-500 ${fadeArticle ? "opacity-100" : "opacity-0"}`}>
              <div className="md:flex">
                <div className="md:w-1/3">
                  <img className="h-96 w-full object-cover" src={artikel.gambar} alt={artikel.judul} />
                </div>
                <div className="p-8 md:w-2/3 flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="text-3xl font-bold text-gray-800 mb-4 hover:text-[#2596be] transition-colors">{artikel.judul}</h3>
                    <p className="text-gray-700 text-lg leading-relaxed">{artikel.ringkasan}</p>
                  </div>
                  <button
